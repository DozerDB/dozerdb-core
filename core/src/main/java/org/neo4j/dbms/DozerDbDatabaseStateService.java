 ...
 */
public final class DozerDbDatabaseStateService implements DatabaseStateService {

    private final MultiDatabaseManager databaseManager;

    public DozerDbDatabaseStateService(MultiDatabaseManager databaseManager) {
    ...
    public DatabaseState stateOfDatabase(NamedDatabaseId namedDatabaseId) {
        return databaseManager
                ...
                .map(DozerDbDatabaseStateService::getState)
